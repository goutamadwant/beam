...
* X feature added (Java/Python) ([#X](https://github.com/apache/beam/issues/X)).
* (Java) `Watch.growthOf(...).withMaxPendingResults()` can limit the checkpointed pending outputs from repeatable incomplete polls ([#18459](https://github.com/apache/beam/issues/18459)).
