...
* (Java) The Flink runner now preserves watermark holds for `@RequiresStableInput` records buffered after a checkpoint snapshot ([#39991](https://github.com/apache/beam/issues/39991)).
